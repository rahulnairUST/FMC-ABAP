/********** GENERATED on 08/17/2023 at 09:00:15 by CB9980000010**************/
 @OData.entitySet.name: 'A_SalesOrderItemPrElement' 
 @OData.entityType.name: 'A_SalesOrderItemPrElementType' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZUST01_A_SALESORDERITEMPRELEME { 
...
//On-condition is not relevant for runtime 
 _SalesOrder1234 : association [1] to ZUST01_A_SALESORDER on 1 = 1; 
 @OData.property.name: 'to_SalesOrderItem' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SalesOrderItem1 : association [1] to ZUST01_A_SALESORDERITEM on 1 = 1; 
 } 
