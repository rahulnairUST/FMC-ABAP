CLASS zust01_cl_stock DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES: rt_dats  TYPE if_rap_query_filter=>tt_range_option,
           tt_stock TYPE TABLE OF ZUST01_MATERIALMULTISTOCKBYDAT WITH DEFAULT KEY.
    ...
    METHODS get_stock
      ...
      EXPORTING
        et_business_data TYPE  tt_stock
      RAISING
        /iwbep/cx_cp_remote
        /iwbep/cx_gateway
...
*    ENDTRY.
  ...
  METHOD get_stock.
    ...
    TRY.
        ...
        lo_request = lo_client_proxy->create_resource_for_entity_set( 'MaterialMultiStockByDate' )->create_request_for_read( ).
