CLASS lhc_ZUST01_CE_SCRROW DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR zust01_ce_scrrow RESULT result.

    METHODS create FOR MODIFY
      IMPORTING entities FOR CREATE zust01_ce_scrrow.

    METHODS update FOR MODIFY
      IMPORTING entities FOR UPDATE zust01_ce_scrrow.

    METHODS delete FOR MODIFY
      IMPORTING keys FOR DELETE zust01_ce_scrrow.

    METHODS read FOR READ
      IMPORTING keys FOR READ zust01_ce_scrrow RESULT result.

    METHODS lock FOR LOCK
      IMPORTING keys FOR LOCK zust01_ce_scrrow.

ENDCLASS.

CLASS lhc_ZUST01_CE_SCRROW IMPLEMENTATION.
  ...
  ls_rowtable-local_last_changed_at = ls_entities-LocalLastChagnedAt.
  ...
  ls_rowtable-created_at = ls_entities-CreatedAt.
  ls_rowtable-local_last_changed_by = ls_entities-LocalLastChangedBy.
  ls_rowtable-local_last_chagned_at = ls_entities-LocalLastChagnedAt.
  ls_rowtable-last_changed_at = ls_entities-LastChangedAt.
...
CLASS lsc_ZUST01_CE_SCRROW DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZUST01_CE_SCRROW IMPLEMENTATION.
